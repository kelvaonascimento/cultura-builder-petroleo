...
export const RADAR: ItemRadar[] = [
  {
    ...
    severidade: "alta",
    tipo: "risco",
    situacao: "Res. ANP 1.004/2026 (distribuição): compara a margem bruta do próprio agente entre períodos; filtro inicial de alta de 70%; 30 dias para comprovar custos. Multas de R$ 50.000,00 a R$ 500.000.000,00, com responsabilidade de sócios e administradores.",
    data: "23/09/2026",
  ...
  },
  {
    ...
    severidade: "alta",
    tipo: "risco e oportunidade",
    situacao: "Combustíveis têm regime próprio (incidência única, alíquota por litro, uniforme no país). A CBS substitui PIS/Cofins em 01/01/2027; o IBS entra em 2029 e a transição termina em 2033 (LC 214/2025, alterada pelas LCs 227 e 235/2026).",
    data: "28/08/2026",
  ...
  },
  {
    ...
    severidade: "média",
    tipo: "risco e oportunidade",
    situacao: "Res. CNPE 9/2026: etanol anidro a 32% na gasolina C comum e aditivada desde 01/08/2026, por 180 dias prorrogáveis uma vez; premium segue com 25%. Biodiesel segue em B15 (Lei 14.993/2024).",
    data: "31/07/2026",
  ...
  },
  {
    ...
    severidade: "média",
    tipo: "risco",
    situacao: "Consulta Pública ANP 17/2026 (aprovada em 21/08/2026): distribuidores terão de comprovar estoques e compras de biodiesel compatíveis com o diesel B vendido; hoje o controle é mensal, pelo i-SIMP.",
    data: "27/08/2026",
  ...
  {
    id: "std",
    titulo: "Preços e volumes reportados à ANP a cada 14 dias",
    categoria: "ANP",
    severidade: "média",
    tipo: "risco e oportunidade",
    situacao: "Decreto 12.930/2026: distribuidores enviam volumes e preços de compra e venda ao Sistema de Transparência na Distribuição (STD) em períodos de 14 dias; a ANP publica painel agregado desde 25/06/2026.",
    data: "25/06/2026",
    impacto: "Erro ou atraso vira infração e os dados alimentam a fiscalização de abusividade; o painel público serve de benchmark de margem.",
    agente: "Agente ANP",
...
export const ACOES: { agente: string; acao: string; norma: string; resultado: "ok" | "atenção" | "bloqueado" }[] = [
  ...
  { agente: "Agente ANP", acao: "Arquivo de preços e volumes da quinzena gerado para o STD", norma: "Decreto 12.930/2026", resultado: "ok" },
